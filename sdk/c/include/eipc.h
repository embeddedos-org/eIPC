...
eipc_status_t eipc_chat_request_to_json(const eipc_chat_request_t *req, char *buf, size_t buf_size, size_t *written);
eipc_status_t eipc_chat_request_from_json(const char *json, size_t json_len, eipc_chat_request_t *req);
eipc_status_t eipc_chat_response_to_json(const eipc_chat_response_t *resp, char *buf, size_t buf_size, size_t *written);
eipc_status_t eipc_chat_response_from_json(const char *json, size_t json_len, eipc_chat_response_t *resp);
...
eipc_status_t eipc_client_send_chat(eipc_client_t *c, const eipc_chat_request_t *req);
eipc_status_t eipc_client_send_complete(eipc_client_t *c, const char *prompt,
